...
A=load('J_values_1.0_1.0_1.0_1.0_single_cell_gna.txt');
B=load('J_values_1.0_1.0_1.0_1.0_single_cell_gcal.txt');
C=load('J_values_1.0_1.0_1.0_1.0_single_cell_gkr.txt');
D=load('J_values_1.0_1.0_1.0_1.0_single_cell_gk1.txt');
subplot(2,1,1)
...
ylabel('$\mathcal{J}_{\mbox{single cell}}$ (left side)','FontSize',20,'Interpreter','Latex')
...
xlabel('Percentage of default value','FontSize',20,'Interpreter','Latex')
ylabel('$\mathcal{J}_{\mbox{single cell}}$ (right side)','FontSize',20,'Interpreter','Latex')
set(gca, 'XTick', [0.5 0.6 0.7 0.8 0.9 0.95 1.0 1.05 1.1 1.2 1.3 1.4 1.5])
%set(gca, 'XTickLabel', {'$50\%$','$60\%$','$70\%$','$80\%$','$90\%$','$95\%$','$100\%$','$105\%$','$110\%$','$120\%$','$130\%$','$140\%$','$150\%$'})
set(gca, 'XTickLabel', {'$50$','$60$','$70$','$80$','$90$','$95$','$100$','$105$','$110$','$120$','$130$','$140$','$150$'})
set(gca,'FontSize',15,'TickLabelInterpreter', 'Latex')
...
xlabel('Percentage of default value','FontSize',20,'Interpreter','Latex')
ylabel('$\mathcal{J}_{\mbox{single cell}}$ (total)','FontSize',20,'Interpreter','Latex')
set(gca, 'XTick', [0.5 0.6 0.7 0.8 0.9 0.95 1.0 1.05 1.1 1.2 1.3 1.4 1.5])
%set(gca, 'XTickLabel', {'$50\%$','$60\%$','$70\%$','$80\%$','$90\%$','$95\%$','$100\%$','$105\%$','$110\%$','$120\%$','$130\%$','$140\%$','$150\%$'})
set(gca, 'XTickLabel', {'$50$','$60$','$70$','$80$','$90$','$95$','$100$','$105$','$110$','$120$','$130$','$140$','$150$'})
set(gca,'FontSize',15,'TickLabelInterpreter', 'Latex')
