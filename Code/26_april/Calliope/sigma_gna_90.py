...
cell_model.set_parameters(GNa=23*0.9)
...
# Save time steps
np.savetxt("Results/recorded_times_gna_90.txt", times)

# # Save v and [Ca]_i at point in centre and point in corner
np.savetxt("Results/v_centre_gna_90.txt", v_centre)
np.savetxt("Results/v_corner_gna_90.txt", v_corner)
np.savetxt("Results/cai_centre_gna_90.txt", cai_centre)
np.savetxt("Results/cai_corner_gna_90.txt", cai_corner)
