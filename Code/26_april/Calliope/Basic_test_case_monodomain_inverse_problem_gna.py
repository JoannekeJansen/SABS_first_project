...
if __name__ == "__main__":
    ...
    if Evaluate_J == True:
        M = 50 # Number of functional evaluations
        J_values = np.zeros(M)
        orig_val = 23.0    # the value of the control variable that was used to generate the recorded data
        control_values=np.linspace(10, 40, num=M)
        ...
        np.savetxt("Results/J_values_gna.txt", np.column_stack((J_values, control_values)))
