# Solver for the inverse problem of create_initial_conditions_12mm_strip.py and creat_observations_12mm_strip.py
# ===========================================================
#
...
if __name__ == "__main__":
    ...
    if Optimize == True:
        rf = ReducedFunctional(J, [Control(ctrl4)] , eval_cb_post = eval_cb_post, derivative_cb_post = derivative_cb_post)
