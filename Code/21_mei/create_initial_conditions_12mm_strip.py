...
# Save data
np.savetxt("recorded_times_12mm_strip.txt", times)
np.savetxt("v_left_12mm_strip.txt", v_left)
np.savetxt("v_right_12mm_strip.txt", v_right)
np.savetxt("cai_left_12mm_strip.txt", cai_left)
np.savetxt("cai_right_12mm_strip.txt", cai_right)        
