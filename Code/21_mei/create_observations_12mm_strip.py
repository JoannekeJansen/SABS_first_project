...
def main(model):
  ...
  hdf_v = HDF5File(mesh.mpi_comm(), "observed_v_12mm_strip.h5", "w")
  hdf_cai = HDF5File(mesh.mpi_comm(), "observed_cai_12mm_strip.h5", "w")
  times = []
  i=0
  ...
  # Save time steps
  np.savetxt("observed_times_12mm_strip.txt", times)
