...
def main(model):
  ...
  hdf_v = HDF5File(mesh.mpi_comm(), 'observed_v_12mm_strip_{0}_{1}_{2}_{3}_{4}_{5}_{6}.h5'.format(noise_percentage_sigma_t, \
  ...
  hdf_cai = HDF5File(mesh.mpi_comm(), 'observed_cai_12mm_strip_{0}_{1}_{2}_{3}_{4}_{5}_{6}.h5'.format(noise_percentage_sigma_t, \
   noise_percentage_gna, noise_percentage_gk1, noise_percentage_gkr, noise_percentage_gcal, noise_percentage_v, noise_percentage_cai), "w")
  times = []
  i=0
  ...
  # Save time steps
  np.savetxt('observed_times_12mm_strip_{0}_{1}_{2}_{3}_{4}_{5}_{6}.txt'.format(noise_percentage_sigma_t, \
