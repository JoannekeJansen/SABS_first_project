...
"""This module contains a Paci2013_ventricular_adjusted cardiac cell model
...
class Paci2013_ventricular_adjusted(CardiacCellModel):
    ...
    def default_parameters():
        ...
        params = OrderedDict([("g_Na_factor", 1),
                              ("g_CaL_factor", 1),
                              ("g_Kr_factor", 1),
                              ("g_K1_factor", 1),
    ...
    def _I(self, v, s, time):
        ...
        # Assign parameters
        g_Na_factor = self._parameters["g_Na_factor"]
    ...
    def __str__(self):
        return 'Paci2013_ventricular_adjusted cardiac cell model'
