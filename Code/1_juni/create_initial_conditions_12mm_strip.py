...
sigma_t = 0.001*20          # mu S / mm
sigma_l = 0.001*200         # mu S / mm
...
# Save data
np.savetxt("recorded_times_12mm_strips.txt", times)
np.savetxt("v_left_12mm_strips.txt", v_left)
np.savetxt("v_right_12mm_strips.txt", v_right)
np.savetxt("cai_left_12mm_strips.txt", cai_left)
np.savetxt("cai_right_12mm_strips.txt", cai_right)        
