...
"""This module contains a Paci_hyttinen_aaltosetala_severi_ventricularVersion cardiac cell model
...
class Paci_hyttinen_aaltosetala_severi_ventricularVersion(CardiacCellModel):
    ...
    def __str__(self):
        return 'Paci_hyttinen_aaltosetala_severi_ventricularVersion cardiac cell model'
