...
params = Paci2013_ventricular_adjusted.default_parameters()
...
model.set_parameters(g_Kr_factor=0.0)

(times, v_left, v_right, cai_left, cai_right) = main(model)

# # Save data
# np.savetxt("recorded_times_12mm_strip_no_block.txt", times)
# np.savetxt("v_left_12mm_strip_no_block.txt", v_left)
# np.savetxt("v_right_12mm_strip_no_block.txt", v_right)
# np.savetxt("cai_left_12mm_strip_no_block.txt", cai_left)
# np.savetxt("cai_right_12mm_strip_no_block.txt", cai_right)        


# Save data
np.savetxt("recorded_times_12mm_strip_gkr_block.txt", times)
np.savetxt("v_left_12mm_strip_gkr_block.txt", v_left)
np.savetxt("v_right_12mm_strip_gkr_block.txt", v_right)
np.savetxt("cai_left_12mm_strip_gkr_block.txt", cai_left)
np.savetxt("cai_right_12mm_strip_gkr_block.txt", cai_right)        
