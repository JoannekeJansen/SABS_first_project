...
vtkfile_v = File('v_gna_12mm_strip.pvd')
vtkfile_cai = File('cai_gna_12mm_strip.pvd')
i = main(0.5,1.0,1.0,1.0)
i = main(0.75,1.0,1.0,1.0)
i = main(1.0,1.0,1.0,1.0)
i = main(1.25,1.0,1.0,1.0)
i = main(1.5,1.0,1.0,1.0)
del vtkfile_v, vtkfile_cai

vtkfile_v = File('v_gcal_12mm_strip.pvd')
vtkfile_cai = File('cai_gcal_12mm_strip.pvd')
i = main(1.0,0.5,1.0,1.0)
i = main(1.0,0.75,1.0,1.0)
i = main(1.0,1.0,1.0,1.0)
i = main(1.0,1.25,1.0,1.0)
i = main(1.0,1.5,1.0,1.0)
del vtkfile_v, vtkfile_cai

vtkfile_v = File('v_gk1_12mm_strip.pvd')
vtkfile_cai = File('cai_gk1_12mm_strip.pvd')
i = main(1.0,1.0,0.5,1.0)
i = main(1.0,1.0,0.75,1.0)
i = main(1.0,1.0,1.0,1.0)
i = main(1.0,1.0,1.25,1.0)
i = main(1.0,1.0,1.5,1.0)
del vtkfile_v, vtkfile_cai

vtkfile_v = File('v_gkr_12mm_strip.pvd')
vtkfile_cai = File('cai_gkr_12mm_strip.pvd')
i = main(1.0,1.0,1.0,0.5)
i = main(1.0,1.0,1.0,0.75)
i = main(1.0,1.0,1.0,1.0)
i = main(1.0,1.0,1.0,1.25)
i = main(1.0,1.0,1.0,1.5)
del vtkfile_v, vtkfile_cai
