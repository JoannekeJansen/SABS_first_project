...
"""This module contains a Grandi_pasqualini_bers_2010_adjusted cardiac cell model
...
class Grandi_pasqualini_bers_2010_adjusted(CardiacCellModel):
    ...
    def __str__(self):
        return 'Grandi_pasqualini_bers_2010_adjusted cardiac cell model'
