...
load('cai_centre_adjusted_Cal150.txt')
load('cai_corner_adjusted_Cal150.txt')
load('v_corner_adjusted_Cal150.txt')
load('v_centre_adjusted_Cal150.txt')
...
load('cai_centre_adjusted_Cal50.txt')
load('cai_corner_adjusted_Cal50.txt')
load('v_corner_adjusted_Cal50.txt')
load('v_centre_adjusted_Cal50.txt')

subplot(1,2,1)
hold on

plot(recorded_times2,cai_centre_adjusted_Cal50, 'Linewidth', 3)
plot(recorded_times2,cai_centre_adjusted_Cal100, 'Linewidth', 3)
plot(recorded_times2,cai_centre_adjusted_Cal150, 'Linewidth', 3)
plot(recorded_times2,cai_corner_adjusted_Cal50, 'Linewidth', 3)
plot(recorded_times2,cai_corner_adjusted_Cal100, 'Linewidth', 3)
plot(recorded_times2,cai_corner_adjusted_Cal150, 'Linewidth', 3)
...
plot(recorded_times2,v_centre_adjusted_Cal50, 'Linewidth', 3)
plot(recorded_times2,v_centre_adjusted_Cal100, 'Linewidth', 3)
plot(recorded_times2,v_centre_adjusted_Cal150, 'Linewidth', 3)
plot(recorded_times2,v_corner_adjusted_Cal50, 'Linewidth', 3)
plot(recorded_times2,v_corner_adjusted_Cal100, 'Linewidth', 3)
plot(recorded_times2,v_corner_adjusted_Cal150, 'Linewidth', 3)
