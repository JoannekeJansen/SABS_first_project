...
\begin{eqnarray}
%\mathcal{J}(v, [\mathrm{Ca}]_{\mathrm{i}}, \boldsymbol{c})= \\
...
\end{eqnarray}
%%\begin{eqnarray} \nonumber
%%\mathcal{J}(v, c, \sigma_l)= \\ \frac{1}{N} \sum_{i=1}^{N} \int_{H}(v(\textbf{x},t_{\mathrm{i}})-\Phi(\textbf{x},t_{\mathrm{i}}))^2 \: \text{d}\textbf{x} + \int_{H}\left(c(\textbf{x},t_{\mathrm{i}})-\Psi(\textbf{x},t_{\mathrm{i}})\right)^2 \: \text{d}\textbf{x},\label{J}
%%\end{eqnarray}
...
%We also see that the voltage peak of the tissue data is less sharp than that of the single cell data, due to diffusion. By decreasing the conductivity parameters, the shape of the action potential wave of the single cell data and tissue data can be made more similar.
%
...
%In Figures \ref{fig:??}-\ref{fig:??}, we show the heat maps of $[\mathrm{Ca}]_{\mathrm{i}}$ and $v$ for varying $g_{\mathrm{CaL}}$, $g_{\mathrm{Kr}}$, $g_{\mathrm{K1}}$ and $\sigma_t$ when $I_{\mathrm{Na}}$ is fully blocked.
%
\begin{figure}
...
%RED: We note oscillating behaviour. nauwkeuriger dan dit wordt t niet.
%%
%\begin{table*}
%\begin{center}
...
%    \hline
%    $\mathcal{J}$ & $1.05 \times 10^{-1}$  &   $1.01 \times 10^{-1}$ & $4.51 \times 10^{-7}$  &  $3.73 \times 10^{-7}$  \\
%    $g_{\mathrm{Na}}$ & $90.000 \%$  &  $90.200 \%$ & $100.001 \%$  &  $100.000 \%$  \\
%        \hline
%    $\mathcal{J}$ & $5.55 \times 10^{-2}$  &   $5.41 \times 10^{-2}$ & $4.68 \times 10^{-7}$  &  $1.46 \times 10^{-7}$  \\
%    $g_{\mathrm{Na}}$ & $110.000 \%$  &  $109.800 \%$ & $100.000 \%$  &  $100.000 \%$  \\
%  \end{tabular}
%  }
%\end{center}
%\caption{The values of $\mathcal{J}$ and $g_{\mathrm{Na}}$ at the start of each iteration of the IPOPT algorithm.}
%\label{table:1}
%\end{table*}
\begin{table*}
\begin{center}
...
%    \hline
%    $\mathcal{J}$ & $? \times 10^{-1}$  &   $1.07 \times 10^{-1}$ & $5.69 \times 10^{-2}$  &  $6.16 \times 10^{-3}$ & $1.07 \times 10^{-1}$ & $5.69 \times 10^{-2}$  \\
%    $g_{\mathrm{Na}}$ & $90.000 \%$  &  $90.200 \%$ & $100.001 \%$  &  $100.000 \%$  \\
%    $g_{\mathrm{CaL}}$ & $90.000 \%$  &  $90.200 \%$ & $100.001 \%$  &  $100.000 \%$  \\
%        \hline
%    $\mathcal{J}$ & $1.03 \times 10^{-2}$  &   $1.03 \times 10^{-2}$ & $1.03 \times 10^{-2}$  &  $6.16 \times 10^{-3}$  \\
%    $g_{\mathrm{Na}}$ & $90.000 \%$  &  $90.200 \%$ & $109.802 \%$  &  $100.000 \%$  \\
%    $g_{\mathrm{CaL}}$ & $90.000 \%$  &  $90.200 \%$ & $109.240 \%$  &  $100.000 \%$  \\
%            \hline
%    $\mathcal{J}$ & $1.03 \times 10^{-2}$  &   $1.03 \times 10^{-2}$ & $1.03 \times 10^{-2}$  &  $6.16 \times 10^{-3}$  \\
%    $g_{\mathrm{Na}}$ & $110.000 \%$  &  $90.200 \%$ & $100.001 \%$  &  $100.000 \%$  \\
%    $g_{\mathrm{CaL}}$ & $90.000 \%$  &  $90.200 \%$ & $100.001 \%$  &  $100.000 \%$  \\
%        \hline
%    $\mathcal{J}$ & $1.03 \times 10^{-2}$  &   $1.03 \times 10^{-2}$ & $1.03 \times 10^{-2}$  &  $6.16 \times 10^{-3}$  \\
%    $g_{\mathrm{Na}}$ & $110.000 \%$  &  $109.800 \%$ & $100.000 \%$  &  $100.000 \%$  \\
%        $g_{\mathrm{CaL}}$ & $110.000 \%$  &  $90.200 \%$ & $100.001 \%$  &  $100.000 \%$  \\
%  \end{tabular}
%  }
%\end{center}
%\caption{The values of $\mathcal{J}$, $g_{\mathrm{Na}}$ and $g_{\mathrm{CaL}}$ at the start of each iteration of the IPOPT algorithm.}
%\label{table:2}
%\end{table*}
