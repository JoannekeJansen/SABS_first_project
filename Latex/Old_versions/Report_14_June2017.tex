...
\begin{center}
  \begin{tabular}{c c | c c | c c | c c }
    ...
    \hline
%    $1.05e^{-1}$ & 0.900  &   $1.02e^{-2}$ & 0.900  &   0 &   0.90 & 0 &   0.90 \\
%    $5.53e^{-2}$ & 1.10  &   $7.99e^{-3}$ & 1.10  &   0 &   0.90 & 0 &   0.90 \\
%    $1.67e^{-2}$ & 0.968  &   $4.49e^{-4}$ & 0.979  &   0 &   0.90 & 0 &   0.90 \\
%    $9.90e^{-2}$ & 0.921  &   $5.76e^{-3}$ & 0.925  &   0 &   0.90 & 0 &   0.90 \\
%    $1.03e^{-1}$ & 0.904  &   $8.92e^{-3}$ & 0.907  &   0 &   0.90 & 0 &   0.90 \\
%    $1.04e^{-1}$ & 0.901  &   $9.97e^{-3}$ & 0.902  &   0 &   0.90 & 0 &   0.90 \\
%    $1.04e^{-1}$ & 0.900  &   $1.02e^{-2}$ & 0.900  &   0 &   0.90 & 0 &   0.90 \\
  \end{tabular}
\end{center}
...
\begin{center}
  \begin{tabular}{c c | c c | c c | c c }
    $\mathcal{J}$ & $g_{Na}$ & $\mathcal{J}$ & $g_{CaL}$ & $\mathcal{J}$ & $g_{Kr}$ &  $\mathcal{J}$ & $g_{K1}$ \\ 
    \hline
%    $5.55e^{-2}$ & 1.10  &   $7.99e^{-3}$ & 1.10  &   0 &   1.10 & 0 &   1.10 \\
%    $1.05e^{-1}$ & 0.900  &   $1.02e^{-2}$ & 0.900  &   0 &   0.90 & 0 &   0.90 \\
%    $5.01e^{-3}$ & 0.984  &   $7.07e^{-5}$ & 0.992  &   0 &   0.90 & 0 &   0.90 \\
%    $1.40e^{-2}$ & 1.03  &   $3.54e^{-3}$ & 1.06  &   0 &   0.90 & 0 &   0.90 \\
%    $5.16e^{-2}$ & 1.09  &   $6.98e^{-3}$ & 1.09  &   0 &   0.90 & 0 &   0.90 \\
%    $5.45e^{-2}$ & 1.01  &   $7.74e^{-3}$ & 1.10  &   0 &   0.90 & 0 &   0.90 \\
%    $5.53e^{-2}$ & 1.01  &   $7.92e^{-3}$ & 1.10  &   0 &   0.90 & 0 &   0.90 \\
  \end{tabular}
\end{center}
...
% We only looked at g, ook naar andere paras kjkjen. Protocollen ontwikkelen. Met drugs erop. En verschillende stimuli. Dat ten volle benutten. Patch clamp: voltage clamp. meet current die gaat lopen. met drugs. Verwijs naar tveito, current clamp zou ook mogelijk moeten zijn. 
\bibliography{refs}
