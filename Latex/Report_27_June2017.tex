...
\resizebox{\columnwidth}{!}{%
  \begin{tabular}{c c | c c | c c | c c }
    $\mathcal{J}$ & $g_{\mathrm{Na}}$ & $\mathcal{J}$ & $g_{\mathrm{CaL}}$ & $\mathcal{J}$ & $g_{\mathrm{Kr}}$ &  $\mathcal{J}$ & $g_{\mathrm{K1}}$ \\ 
    \hline
...
\end{center}
\caption{The values of $\mathcal{J}$ and $g_{\mathrm{Na}}, g_{\mathrm{CaL}}, g_{\mathrm{Kr}}$ and $g_{\mathrm{K1}}$ after each iteration, when optimizing for one of the four parameters at a time. The initial guess is $110\%$ of the original parameter value.}
\label{table:2}
\end{table*}
